...
class PoseEstimator
{
    ...
    private:
        ...
        // Run the calculation without actually updating. Does it 8 times.
        // UpdatePose - whether or not to update the pose after done
        void flush(FusionGroup fgroup, bool updatePose);
