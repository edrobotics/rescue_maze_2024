...
// Returns true if sensor has data ready and false if sensor does not have data ready
...
// Same as readRangeContinuousMillimeters(), but without blocking.
// Check dataReady() first! Otherwise bad things may happen...
uint16_t VL53L0X::readNonBlock()
{
  // Code from readRangeConinuousMillimeters() but without blocking
  // Copied from readRangeContinuousMillimeters() -------------------------
