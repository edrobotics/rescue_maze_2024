...
class MotorController
{
    ...
    void setPWM(int pwmSpeed); // Sets the PWM output. Clamps and returns false if too great.
    ...
    double getOtputSpeed(); // Returns the current speed of the output shaft, measuren in rpm.
    ...
    float Ki {0};
    float Kd {0};
    QuickPID pid {&curMotorSpeed, &pwmCorrection, &motorSpeed, Kp, Ki, Kd, QuickPID::pMode::pOnError, QuickPID::dMode::dOnMeas, QuickPID::iAwMode::iAwCondition, QuickPID::Action::reverse};
